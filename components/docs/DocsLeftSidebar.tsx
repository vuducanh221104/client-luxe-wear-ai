      ...
      <div className="sticky top-24 space-y-6">
        <div>
          ...
          <nav className="space-y-1">
            <a className="flex items-center gap-2 rounded-lg bg-muted px-3 py-2 text-sm font-medium" href="#">
              <span className="text-zinc-400">✦</span> Welcome to Chatbase
            </a>
            <a className="flex items-center gap-2 rounded-lg px-3 py-2 text-sm text-muted-foreground hover:bg-muted" href="#">
