          ...
          <div className="lg:col-span-7">
            <div className="flex items-center justify-between">
              <div>
                ...
                <h1 className="mt-1 text-3xl md:text-4xl font-extrabold tracking-tight">Welcome to LuxeWear</h1>
            ...
            <div className="mt-6 rounded-2xl border bg-muted/40 p-10 flex items-center justify-center">
              <img src="/logoGobal.svg" alt="LuxeWear" className="h-12 w-auto" />
            </div>

            <h2 id="why-choose" className="mt-8 text-2xl md:text-3xl font-bold">Why Choose LuxeWear?</h2>
